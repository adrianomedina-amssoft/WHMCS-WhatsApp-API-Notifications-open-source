...
/**
 * Code: QuoteDeliveredCreated10days
 */
...
final class QuoteDeliveredCreated10daysNotification extends AbstractCronNotification
{
    public function __construct()
    {
        parent::__construct(
            'QuoteDeliveredCreated10days',
            null,
    ...
    public function getPayload(): array
    {
        ...
        ->whereDate('tblquotes.datecreated', $tenDaysAgo)
