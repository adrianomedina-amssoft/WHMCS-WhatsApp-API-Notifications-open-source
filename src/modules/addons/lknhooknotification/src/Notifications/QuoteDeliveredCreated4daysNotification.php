...
/**
 * Code: QuoteDeliveredCreated4days
 */
...
final class QuoteDeliveredCreated4daysNotification extends AbstractCronNotification
{
    public function __construct()
    {
        parent::__construct(
            'QuoteDeliveredCreated4days',
            null,
    ...
    public function getPayload(): array
    {
        ...
        ->whereDate('tblquotes.datecreated', $fourDaysAgo)
