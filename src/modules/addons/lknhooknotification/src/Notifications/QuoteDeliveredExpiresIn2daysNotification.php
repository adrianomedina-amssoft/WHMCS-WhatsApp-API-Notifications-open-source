...
/**
 * Code: QuoteDeliveredExpiresIn2days
 */
...
final class QuoteDeliveredExpiresIn2daysNotification extends AbstractCronNotification
{
    public function __construct()
    {
        parent::__construct(
            'QuoteDeliveredExpiresIn2days',
            null,
